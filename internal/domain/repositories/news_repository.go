...
type NewsRepository interface {
	...
	GetScheduledNews(ctx context.Context, from, to time.Time) ([]*entities.News, error)
	GetExpiredNews(ctx context.Context, before time.Time) ([]*entities.News, error)
	GetExpiringNews(ctx context.Context, from, to time.Time) ([]*entities.News, error)

	// Archive operations
	ArchiveNews(ctx context.Context, id uuid.UUID) error
